...
const Hel = "647129207989731328";
const defaultGuild = "676371564526305291";
...
const goodbyes = ["Goodbye", "Farewell", "So long"];
const leaveQuotes = [
                        ...
                        ["*Goodbye* ", ", this is the hardest part about being an impartial announcer: balancing how little I care about anything thats happening here"],
                        ...
                        ["*Goodbye* ", ", we'll miss you a lot, then a little, then not too much"],
                        ["", " went out to pick up a pack of cigarettes, he will be back anytime soon..."]
                    ];

const gladosCheers = [
                        "Let me record this victory in your file. Where did I put it? Oh, who cares.", "Wait until your loved ones hear about this. This should make them proud. Or bored. One of those.",
                        ...
                        "Here, let me engrave a trophy for you: nobody cares.", "It's a good feeling, isn't it? I wouldn't get used to it.", "This should impress all the people who doubted you at the comic book store.",
                        "This is probably the most heroic thing anyone's ever done while sitting motionless in their parents' rec room.",
                        "So that's a minor victory, right square in the middle of all your failures.", "If you had any idea what you were doing, this would be a real achievement.",
